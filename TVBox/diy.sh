...
# 播放源地址
echo '添加内置播放源地址'
#sed -i 's#"app_source"><#"app_source">https://www.taihe.life/tv/api.json<#g' TVBoxOSC/app/src/main/res/values-zh/strings.xml
#sed -i 's#"app_source"><#"app_source">https://www.taihe.life/tv/api.json<#g' TVBoxOSC/app/src/main/res/values/strings.xml
sed -i 's#"app_source"><#"app_source">https://gitee.com/MINGERTAI/gao/raw/master/0821.json<#g' TVBoxOSC/app/src/main/res/values-zh/strings.xml
sed -i 's#"app_source"><#"app_source">https://gitee.com/MINGERTAI/gao/raw/master/0821.json<#g' TVBoxOSC/app/src/main/res/values/strings.xml
