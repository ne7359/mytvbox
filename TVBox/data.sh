...
#sed -i '/this.activity = activity/a\        Config.create(0,"https://d.kstore.dev/download/9574/xx.json").update();' app/src/main/java/com/fongmi/android/tv/App.java   # 默认点播配置
#echo '添加默认点播配置完成'
#sed -i '/默认点播配置/a\        Config.create(1,"https://d.kstore.dev/download/9574/xx.json").update();' app/src/main/java/com/fongmi/android/tv/App.java   # 默认直播配置
#echo '添加默认直播配置完成'
